...
int main(int count, char *Argc[])
{
    ...
    int server;
    char *portnum;
    char *certPath = ECDSA_CERT_FILE_PATH;
    ...
    while (1){
        ...
        int result = SSL_CTX_add_server_custom_ext(ctx, 1000, ext_add_cb, ext_free_cb, NULL, ext_parse_cb, NULL);
        int result2 = SSL_CTX_add_server_custom_ext(ctx, 2000, ext_add_cb, ext_free_cb, NULL, ext_parse_cb, NULL);
        int result3 = SSL_CTX_add_server_custom_ext(ctx, 3000, ext_add_cb, ext_free_cb, NULL, ext_parse_cb, NULL);
